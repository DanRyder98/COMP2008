 ...
 * @author Daniel Ryder
 */
public class RemoveAssosiation extends javax.swing.JFrame {

    /**
     * Creates new form RemoveAssosiation
     */
    public RemoveAssosiation() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveAssosiation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveAssosiation().setVisible(true);
            }
        });
    }
